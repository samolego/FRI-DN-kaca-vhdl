...
# Zadnji switch je zgolj za simulacijo (mora biti izkljucen na pravi ploscici)
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { SIM }]; #IO_L21P_T3_DQS_14 Sch=sw[15]
